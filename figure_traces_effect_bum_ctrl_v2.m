...
x11=find(tim.uno > 5000 , 1, 'first');
x12=find(tim.uno > 7000 , 1, 'first');
[count1, bincenter1]=hist(diff(isi.uno(x11:x12)),400);%,'facecolor','blue');
plot(bincenter1,count1,'color',g(1,:),'linewidth',2);
hold on

j=find(cluster_class(:,1)==1); 
x13=find(tim.uno > 8100 , 1, 'first');
x14=find(tim.uno > 11100 , 1, 'first');
[count2, bincenter2]=hist( diff(isi.uno(x13:x14)),400);%,'facecolor','red');
...
x11=find(tim.dos > 5000 , 1, 'first');
x12=find(tim.dos > 7000 , 1, 'first');
[count1, bincenter1]=hist(diff(isi.dos(x11:x12)),100);%,'facecolor','blue');
plot(bincenter1,count1,'color',g(11,:),'linewidth',2);
hold on

j=find(cluster_class(:,1)==2); 
x13=find(tim.dos > 8100 , 1, 'first');
x14=find(tim.dos > 11100 , 1, 'first');
[count2, bincenter2]=hist( diff(isi.dos(x13:x14)),100);%,'facecolor','red');
